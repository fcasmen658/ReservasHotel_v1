...
public class HabitacionTest {
    ...
    private static final String PRECIO_HABITACION_NO_ESPERADO = "El precio devuelto no es el mismo que el pasado al constructor.";
    private static final String TIPO_HABITACION_NO_ESPERADA = "El tipo de habitación devuelta no es el mismo que el pasado al constructor.";
